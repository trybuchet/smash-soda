...
class WildfireTheme : public Theme {
public:

    WildfireTheme() : Theme("Wildfire") {

        ImVec4 primary = hexToImVec4("#990000ff");
        ImVec4 secondary = hexToImVec4("#ff3d3dff");
        ...
        textHighlighted = hexToImVec4("#ff3d3dff");
        ...
        navbarIconActive = secondary;

        formLabel = hexToImVec4("#ff3d3dff");
        ...
        formHelpText = hexToImVec4("#FFFFFFFF");

        buttonPrimary = hexToImVec4("#bf1717ff");
        buttonPrimaryBorder = hexToImVec4("#bf1717ff");
