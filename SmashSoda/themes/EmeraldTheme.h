...
class EmeraldTheme : public Theme {
public:

    EmeraldTheme() : Theme("Emerald") {

        ImVec4 primary = hexToImVec4("#219631ff");
        ImVec4 secondary = hexToImVec4("#40d140ff");
        ...
        textHighlighted = hexToImVec4("#22f722ff");
        ...
        formLabel = hexToImVec4("#54f34fff");
