...
public:
    ...
    AquaTheme() : Theme("Aqua") {

        ImVec4 primary = hexToImVec4("#155da1ff");
        ...
        textHighlighted = hexToImVec4("#1ca1faff");
        ...
        navbarIconActive = hexToImVec4("#0a8ee6ff");

        formLabel = hexToImVec4("#1ca1faff");
