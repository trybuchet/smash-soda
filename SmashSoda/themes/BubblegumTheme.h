...
class BubblegumTheme : public Theme {
public:

    BubblegumTheme() : Theme("Bubblegum") {

        ImVec4 primary = hexToImVec4("#ff00c8ff");
        ...
        textHighlighted = hexToImVec4("#fa65ffff");
        ...
        navbarIconActive = hexToImVec4("#f646fcff");

        formLabel = hexToImVec4("#fa65ffff");
